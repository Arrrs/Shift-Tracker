-- Fix auto-income trigger to properly handle "default" pay_override_type
-- The frontend sends pay_override_type='default' when no customization is applied,
-- but the trigger was not handling this case, causing income records not to be created.
